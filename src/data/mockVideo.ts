...
export const mockVideoContent: VideoContent = {
  meta: {
    ...
    duration: 221,
    videoUrl: '/videos/places-living/home-accommodation/legacy-home-tours/pilot-001.mp4',
    dataUrl: '',
    tags: {
      difficulty: 'hard',
      speed: 'fast',
    ...
    thumbnail: '/thumbnails/pilot-001.jpg'
  },
  summary: "This shortened clip focuses on Christina's 450-square-foot studio apartment in East Hollywood. She introduces where she lives, how long she has lived there, how she would describe the apartment, and how she divides a small studio into clear zones: an entryway, a main living space, a bedroom area, and a work area. The clip is suitable for IELTS Home/accommodation answers because it avoids the later long sections about individual objects and keeps the most transferable material about space, layout, style, and personal feeling.\n" +
    '\n' +
    '这版短片聚焦 Christina 在 East Hollywood 的 450 平方英尺单间公寓。她介绍自己住在哪里、住了多久、如何描述这间公寓，以及如何把一个小 studio 分成入口、主生活区、卧室区和工作区。相比原视频，已经删掉了后面大量具体物品和装饰故事，更适合雅思 Home/accommodation 中关于住所、空间布局、个人风格和居住感受的回答。',
  paragraphs: [
    {
      id: 1,
      startTime: 0,
    ...
    },
    {
      ...
      parse: {
        ...
        collocations: [
          {
            phrase: 'good at',
            meaning: '擅长于，后接名词或动名词，此处用 that 从句前置宾语 things'
          },
          {
            phrase: 'approach decor',
            meaning: "着手/对待装饰，approach 作动词表'处理、对待（某任务）'，比 do 更地道"
          },
          {
            phrase: 'see it like the matrix',
            meaning: '像（电影）黑客帝国那样看待它，比喻能瞬间看透事物底层规律'
          }
        ],
    ...
    },
    {
      ...
      parse: {
        ...
        collocations: [
          {
            phrase: 'the bones were really good',
            meaning: "bones 指房屋的基础结构/骨架，'底子好'，是欧美家居装修常用地道说法"
          },
          {
            phrase: 'had character',
            meaning: '有特色/有韵味，character 指空间独特的个性气质'
          },
          {
            phrase: 'do something with this space',
            meaning: "把这个空间利用/改造好，do something with sth. 表'对…有所作为'"
          }
        ],
    ...
    },
    {
      ...
      parse: {
        ...
        collocations: [
          {
            phrase: 'with the idea of',
            meaning: '带着…的想法/理念去做某事，引出做事的出发点'
          },
          {
            phrase: 'compromising at all',
            meaning: 'compromise 妥协、将就；not...at all 完全不，强调毫不让步'
          }
        ],
    ...
    },
    {
      ...
      parse: {
        ...
        collocations: [
          {
            phrase: 'dying testament',
            meaning: "临终遗言/最终见证，testament 指郑重的证明或宣言，dying 夸张强调'盖棺定论'式的代表性"
          },
          {
            phrase: 'what my style is like',
            meaning: '我的风格是什么样，what...be like 询问/描述特征的固定结构'
          }
        ],
    ...
    },
    {
      ...
      parse: {
        ...
        collocations: [
          {
            phrase: 'first time living in a studio',
            meaning: 'first time (doing) sth. 第一次做某事，living 用动名词；studio 指开间公寓（一室无隔断）'
          },
          {
            phrase: 'make sure that',
            meaning: '确保…，后接从句，表刻意保证某事发生'
          },
          {
            phrase: 'divided it into zones',
            meaning: 'divide sth. into zones 把…划分成功能区域，家居布局常用表达'
          }
        ],
    ...
    },
    {
      ...
      parse: {
        ...
        collocations: [
          {
            phrase: 'statement pieces',
            meaning: '亮点单品/主打陈设，指最能彰显个性、引人注目的家具或装饰'
          },
          {
            phrase: 'I was gifted',
            meaning: "gift 作动词的被动用法，'被赠予'，比 was given 更时尚口语化"
          }
        ],
